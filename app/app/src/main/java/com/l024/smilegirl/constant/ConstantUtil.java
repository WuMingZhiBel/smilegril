package com.l024.smilegirl.constant;
...
public class ConstantUtil {
    ...
    public static final String ACCESS_WIFI_STATE= Manifest.permission.ACCESS_WIFI_STATE;//用于访问wifi网络信息，wifi信息会用于进行网络定位
    public static final String CHANGE_WIFI_STATE= Manifest.permission.CHANGE_WIFI_STATE;//这个权限用于获取wifi的获取权限，wifi信息会用来进行网络定位
